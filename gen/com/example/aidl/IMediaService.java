 ...
 * Original file: F:\\Android Application\\MusicPlayer\\src\\com\\example\\aidl\\IMediaService.aidl
 */
package com.example.aidl;
public interface IMediaService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.example.aidl.IMediaService
{
private static final java.lang.String DESCRIPTOR = "com.example.aidl.IMediaService";
...
/**
 * Cast an IBinder object into an com.example.aidl.IMediaService interface,
 * generating a proxy if needed.
 */
public static com.example.aidl.IMediaService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.example.aidl.IMediaService))) {
return ((com.example.aidl.IMediaService)iin);
}
return new com.example.aidl.IMediaService.Stub.Proxy(obj);
}
...
{
data.enforceInterface(DESCRIPTOR);
java.util.List<com.example.model.MusicInfo> _arg0;
_arg0 = data.createTypedArrayList(com.example.model.MusicInfo.CREATOR);
...
data.enforceInterface(DESCRIPTOR);
java.util.List<com.example.model.MusicInfo> _arg0;
_arg0 = new java.util.ArrayList<com.example.model.MusicInfo>();
...
{
data.enforceInterface(DESCRIPTOR);
com.example.model.MusicInfo _result = this.getCurMusic();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
private static class Proxy implements com.example.aidl.IMediaService
{
...
@Override public void refreshMusicList(java.util.List<com.example.model.MusicInfo> musicList) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void getMusicList(java.util.List<com.example.model.MusicInfo> musicList) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_reply.readException();
_reply.readTypedList(musicList, com.example.model.MusicInfo.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
@Override public com.example.model.MusicInfo getCurMusic() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.example.model.MusicInfo _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCurMusic, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.example.model.MusicInfo.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
public void refreshMusicList(java.util.List<com.example.model.MusicInfo> musicList) throws android.os.RemoteException;
public void getMusicList(java.util.List<com.example.model.MusicInfo> musicList) throws android.os.RemoteException;
...
public com.example.model.MusicInfo getCurMusic() throws android.os.RemoteException;
}
